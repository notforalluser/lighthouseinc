...
//           {[
//             { icon: GraduationCap, title: "Professional Training", desc: "Live-led learning experiences that build lasting capabilities and confidence." },
//             { icon: Briefcase, title: "Career Services", desc: "Resume, interview, and placement support that helps learners show up prepared." },
//             { icon: Users, title: "Employer Solutions", desc: "Customized recruiting and workforce strategies for ambitious teams." },
//             { icon: Handshake, title: "Partnership Growth", desc: "We strengthen training ecosystems with people-first collaboration." },
//           ].map((service, index) => (
//             <motion.div
//               key={index}
...
//           className="bg-white/80 backdrop-blur-sm border border-blue-100/50 rounded-2xl p-6 md:p-8 transition-all duration-300"
//         >
    ...
    <section ref={ref} className="min-h-screen py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="relative rounded-xl overflow-hidden h-64 md:h-auto group">
            <img 
